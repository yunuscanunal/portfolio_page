...
const Experience = () => {
  ...
  if (error) {
    console.error("Experience Error UI Triggered:", error);
    // İsterseniz burada bir hata bileşeni return edebilirsiniz.
    // Şimdilik return yapısını aşağıya (başarı durumuna) taşıyoruz.
  }
  return (
    <section
      id="experience"
